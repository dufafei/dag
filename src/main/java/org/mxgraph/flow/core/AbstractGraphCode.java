...
public abstract class AbstractGraphCode implements GraphCode {
    ...
    public abstract AbstractMeta decode(mxGraph graph) throws Exception;
    ...
    abstract public void encode(AbstractMeta meta, mxGraph graph) throws Exception;
}
